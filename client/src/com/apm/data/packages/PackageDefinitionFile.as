...
package com.apm.data.packages
{
	...
	public class PackageDefinitionFile
	{
		...
		public function parse( content:String ):void
		{
			...
			{
				for (var group:String in data.platformParameters)
				{
					var platformConfiguration:PlatformConfiguration = PlatformConfiguration.fromObject(
							group,
							data.platformParameters[group] );
					if (platformConfiguration != null)
						_packageVersion.platformConfigurations.push( platformConfiguration );
				}
			}
		...
		public function stringify():String
		{
			...
			var keyOrder:Array = [ "id", "name", "url", "docUrl", "description", "type", "version", "sourceUrl", "publishedAt", "dependencies", "parameters", "tags", "platforms", "platformParameters", "license", "purchaseUrl", "status" ];
		...
		public function toObject( forceObjectOutput:Boolean = false, outputChecksum:Boolean = false ):Object
		{
			...
			for each (var pp:PlatformConfiguration in _packageVersion.platformConfigurations)
			{
