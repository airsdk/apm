...
package com.apm.remote.repository
{
	...
	public interface Repository extends IEventDispatcher
	{
		...
		function search( query:String, callback:Function = null ):void;
		
		function getPackage( identifier:String, callback:Function = null ):void;
		
		function getPackageVersion( identifier:String, version:SemVer, callback:Function = null ):void;
