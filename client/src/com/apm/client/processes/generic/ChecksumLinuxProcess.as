...
package com.apm.client.processes.generic
{
	...
	public class ChecksumLinuxProcess extends ChecksumAS3Process
	{
		////////////////////////////////////////////////////////
		//  CONSTANTS
		//
		
		private static const TAG:String = "ChecksumLinuxProcess";
		...
		public function ChecksumLinuxProcess( core:APM, file:File )
		{
			super( core, file );
		}
